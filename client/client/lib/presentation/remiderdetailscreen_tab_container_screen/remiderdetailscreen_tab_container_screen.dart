...
class RemiderdetailscreenTabContainerScreen extends StatefulWidget {
  const RemiderdetailscreenTabContainerScreen({Key? key}) : super(key: key);

  @override
  RemiderdetailscreenTabContainerScreenState createState() =>
      RemiderdetailscreenTabContainerScreenState();
}

// ignore_for_file: must_be_immutable
class RemiderdetailscreenTabContainerScreenState
    extends State<RemiderdetailscreenTabContainerScreen>
